---
title: Multilingual Serverless XLM RoBERTa with HuggingFace, AWS Lambda
author: Philipp Schmid
date: 2020-12-17
image: ./images/cover.jpg
excerpt:
  Learn how to build a Multilingual Serverless BERT Question Answering API with a model size of more than 2GB and then
  testing it in German and France.
tags:
  - AWS
  - Serverless
  - BERT
links:
  github: https://github.com/philschmid/multilingual-serverless-qa-aws-lambda
photograph: Photo by Timon Klauser on Unsplash
---
...
![architecture](./images/architektur.png)
