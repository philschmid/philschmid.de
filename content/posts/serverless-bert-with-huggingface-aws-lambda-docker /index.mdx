---
title: Serverless BERT with HuggingFace, AWS Lambda, and Docker
author: Philipp Schmid
date: 2020-12-06
image: ./images/cover.jpg
excerpt:
  Learn how to use the newest cutting edge computing power of AWS with the benefits of serverless architectures to
...
tags:
  ...
  - BERT
links:
  github: https://github.com/philschmid/serverless-bert-huggingface-aws-lambda-docker
...
![bert-context](./images/bert-context.png)
...
![local-request](./images/local-request.png)
...
For an ECR image, the URL should look like tihs `<account>.dkr.ecr.<region>.amazonaws.com/
