---
title:  "Accelerated document embeddings with Hugging Face Transformers and AWS Inferentia"
...
notebook: [sentence-transformers-huggingface-inferentia](https://github.com/philschmid/sentence-transformers-huggingface-inferentia/blob/main/sagemaker-notebook.ipynb)
