...
excerpt: Learn how to train distributed models for summarization using Hugging Face Transformers and Amazon SageMaker and upload them afterwards to huggingface.co.
tags:
  - AWS
  - HuggingFace
  - BART
links:
  github: https://github.com/huggingface/notebooks/tree/master/sagemaker/08_distributed_summarization_bart_t5
...
![inference](./images/inference-test.png)
